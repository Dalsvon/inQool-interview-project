...
public class ReservationRestController {
    ...
    @GetMapping("/court/{id}")
    @Operation(summary = "Find all reservations for the court", description = "Returns all reservations for the given court ordered by date of creation")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Reservations found")
    })
    ...
    @GetMapping("/user")
    @Operation(summary = "Find all reservations for the user", description = "Returns all reservations for the given user and optionally only those starting in future")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Reservations found")
    })
    ...
    @PostMapping
    @Operation(summary = "Create a new reservation", description = "Creates a new reservation and returns its cost in CZK.")
    @ApiResponses(value = {
